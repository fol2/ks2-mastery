...
export const PUNCTUATION_CONTENT_MANIFEST = Object.freeze({
  ...
  releaseId: PUNCTUATION_RELEASE_ID,
  releaseName: 'Endmarks, Apostrophe, Speech, Comma / Flow and Boundary',
  partialReleaseLabel: 'Published Punctuation release',
  fullSkillCount: PUNCTUATION_SKILLS.length,
  publishedScopeCopy: 'This published Punctuation release covers Endmarks, Apostrophe, Speech, Comma / Flow and Boundary. Structure punctuation remains planned.',
