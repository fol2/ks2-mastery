...
export const PUNCTUATION_SKILLS = Object.freeze([
  ...
  },
  {
    ...
    prereq: ['list_commas'],
    published: true,
    rule: 'A colon can introduce a list after a complete opening sentence.',
  ...
  },
  {
    ...
    prereq: ['sentence_endings'],
    published: true,
    rule: 'A semi-colon can join two closely related whole sentences.',
  ...
  },
  {
    ...
    prereq: ['sentence_endings'],
    published: true,
    rule: 'A dash can mark a sharp boundary between two closely related whole sentences.',
