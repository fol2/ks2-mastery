...
export const PUNCTUATION_REWARD_UNITS = Object.freeze([
  ...
  rewardUnit({
    ...
    clusterId: 'boundary',
    skillIds: ['semicolon'],
    evidenceItemIds: ['sc_choose_rain_pitch', 'sc_insert_lights_audience', 'sc_fix_path_map', 'sc_transfer_rain_pitch', 'sc_combine_rain_pitch'],
  }),
  rewardUnit({
  ...
  rewardUnit({
    ...
    clusterId: 'structure',
    skillIds: ['parenthesis'],
    evidenceItemIds: ['pa_choose_coach', 'pa_insert_museum', 'pa_fix_author', 'pa_transfer_library', 'pa_combine_lighthouse'],
  }),
  rewardUnit({
    id: 'colons-core',
    clusterId: 'structure',
