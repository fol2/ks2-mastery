...
export const PUNCTUATION_ITEMS = Object.freeze([
  ...
  },
  {
    ...
    accepted: ['The door creaked open - we froze.'],
  ...
  },
  {
    ...
    accepted: ['The signal failed - the team waited.'],
  ...
  },
  {
    ...
    accepted: ['The museum, a former station, was busy.'],
    explanation: 'The extra information a former station is marked off with commas.',
  ...
  },
  {
    ...
    accepted: ['The author, who won the prize, smiled.'],
  ...
  },
  {
    ...
    clusterId: 'structure',
    rewardUnitId: 'parenthesis-core',
    prompt: 'Write one sentence that adds this parenthesis with commas: which opened last year.',
    stem: '',
    accepted: ['The library, which opened last year, is busy.'],
    explanation: 'The parenthesis is marked with a comma before and after the extra information.',
  ...
  },
  {
    ...
    misconceptionTags: ['structure.bullet_colon_missing', 'structure.bullet_marker_missing', 'structure.list_words_changed'],
    readiness: ['constrained_transfer', 'misconception', 'negative_test'],
    source: 'fixed',
  },
]);
...
export const PUNCTUATION_REWARD_UNITS = Object.freeze([
  ...
  rewardUnit({
    ...
    clusterId: 'comma_flow',
    skillIds: ['comma_clarity'],
    evidenceItemIds: ['cc_choose_grandma', 'cc_insert_time_travellers', 'cc_fix_when_rain_stopped', 'cc_transfer_morning'],
  }),
  rewardUnit({
    id: 'semicolons-core',
    clusterId: 'boundary',
  ...
  rewardUnit({
    ...
    clusterId: 'structure',
    skillIds: ['semicolon_list'],
    evidenceItemIds: ['sl_choose_cities', 'sl_insert_cities', 'sl_fix_captains', 'sl_transfer_places'],
  }),
  rewardUnit({
