...
export const PUNCTUATION_RELEASE_ID = 'punctuation-r2-endmarks-apostrophe-speech-comma-flow';
...
export const PUNCTUATION_CONTENT_MANIFEST = Object.freeze({
  ...
  releaseId: PUNCTUATION_RELEASE_ID,
  releaseName: 'Endmarks, Apostrophe, Speech and Comma / Flow',
  partialReleaseLabel: 'Published Punctuation release',
  fullSkillCount: PUNCTUATION_SKILLS.length,
  publishedScopeCopy: 'This published Punctuation release covers Endmarks, Apostrophe, Speech and Comma / Flow. Structure and boundary punctuation remain planned.',
