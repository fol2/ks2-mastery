...
test('browser migration smoke covers the React app root, Grammar completeness controls, and spelling interaction contract', {
  ...
  try {
    const output = browseChain(binary, [
      ...
      ['wait', '[data-punctuation-cta]'],
      ['text'],
      ['click', '[data-punctuation-cta]'],
      ...
      ['js', "document.querySelector('.grammar-dashboard .grammar-start-row .btn.primary')?.click(); 'started grammar smart';"],
