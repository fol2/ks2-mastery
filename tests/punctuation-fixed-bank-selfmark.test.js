...
// Sanity: P12 expands the fixed authored bank to 512 items.
test('fixed bank contains 512 items', () => {
  assert.equal(fixedItems.length, 512, `Expected 512 fixed items, got ${fixedItems.length}`);
});
