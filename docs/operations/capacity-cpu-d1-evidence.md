...
The 2026-04-30 P3-T0 smoke confirmed that this package script can emit the live pretty JSON stream shape needed for finite Cloudflare CPU/wall joins. The committed proof is diagnostic-only:
