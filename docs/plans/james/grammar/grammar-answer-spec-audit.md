...
- **P18 release is active.** QG P18 uses `grammar-qg-p18-2026-05-02` and adds separate P18 fixtures/evidence. Historical QG fixtures remain unchanged unless explicitly marked as historical gates.
...
| `combine_clauses_rewrite` | `clauses` | rewrite | answerSpec: acceptedSet | `acceptedSet` | When the gate opened, the children ran outside. | unsupported paraphrase | medium | YES |
...
| `tense_rewrite` | `tense_aspect` | rewrite | answerSpec: normalisedText | `normalisedText` | They had finished the model before lunch. | grammar target changed | medium | YES |
...
| `active_passive_rewrite` | `active_passive` | rewrite | answerSpec: normalisedText | `normalisedText` | Sofia carried the lantern. | grammar target changed | high | YES |
...
| `proc2_standard_english_fix` | `standard_english` | fix | answerSpec: normalisedText | `normalisedText` | Ava doesn't know why the gate is locked. | grammar target changed | medium | YES |
...
| `proc2_passive_to_active` | `active_passive` | rewrite | answerSpec: normalisedText | `normalisedText` | Amira lifts the lantern this morning. | grammar target changed | high | YES |
...
| `proc3_clause_join_rewrite` | `clauses` | rewrite | answerSpec: acceptedSet | `acceptedSet` | We stayed inside because it was raining. | unsupported paraphrase | medium | YES |
...
| `proc3_apostrophe_rewrite` | `apostrophes_possession` | rewrite | answerSpec: normalisedText | `normalisedText` | Luca's coats | grammar target changed | medium | YES |
...
| `qg_p14_standard_english_constructed_rewrite` | `standard_english` | rewrite | answerSpec: normalisedText | `normalisedText` | Ben did the library pass before tea. | grammar target changed | medium | YES |
...
| `qg_p14_fronted_adverbials_constructed_rewrite` | `adverbials` | rewrite | answerSpec: normalisedText | `normalisedText` | Before the final bell, Eli carried the history poster carefully. | grammar target changed | medium | YES |
...
| `qg_p14_subject_object_constructed_rewrite` | `subject_object` | rewrite | answerSpec: normalisedText | `normalisedText` | the clay model | grammar target changed | high | YES |
...
| `qg_p14_subordinate_clauses_constructed_rewrite` | `clauses` | rewrite | answerSpec: normalisedText | `normalisedText` | Although the path was muddy, Freya checked the recipe card. | grammar target changed | medium | YES |
...
| `qg_p14_tense_aspect_constructed_rewrite` | `tense_aspect` | rewrite | answerSpec: normalisedText | `normalisedText` | Dylan finished the class trophy yesterday. | grammar target changed | medium | YES |
...
| `qg_p14_speech_punctuation_constructed_rewrite` | `speech_punctuation` | rewrite | answerSpec: normalisedText | `normalisedText` | "Our team won the relay," Cara said. | grammar target changed | medium | YES |
...
| `qg_p14_expanded_noun_phrases_constructed_rewrite` | `noun_phrases` | rewrite | answerSpec: normalisedText | `normalisedText` | the cracked ceramic kite beside the coach bay | grammar target changed | medium | YES |
...
| `qg_p14_parenthesis_commas_constructed_rewrite` | `parenthesis_commas` | rewrite | answerSpec: normalisedText | `normalisedText` | Imani found the science folder, which everyone recognised at once, near the office. | grammar target changed | medium | YES |
...
| `qg_p18_p15_active_passive_voice_rewrite` | `active_passive` | rewrite | answerSpec: normalisedText | `normalisedText` | The bread was baked by the chef. | grammar target changed | high | YES |
...
| `qg_p18_p15_adverbials_fronted_adverbial_comma` | `adverbials` | fix | answerSpec: normalisedText | `normalisedText` | Before sunrise, the campers packed their bags. | grammar target changed | medium | YES |
...
| `qg_p18_p15_adverbials_move_adverbial` | `adverbials` | rewrite | answerSpec: normalisedText | `normalisedText` | Before sunrise, the campers packed their bags. | grammar target changed | medium | YES |
...
| `qg_p18_p15_boundary_punctuation_boundary_fix` | `boundary_punctuation` | fix | answerSpec: normalisedText | `normalisedText` | The sky darkened; the gulls flew inland. | grammar target changed | medium | YES |
...
| `qg_p18_p15_clauses_combine_clause` | `clauses` | rewrite | answerSpec: normalisedText | `normalisedText` | Although the wind was strong, the boat reached the shore. | grammar target changed | medium | YES |
...
| `qg_p18_p15_clauses_repair_sub_fragment` | `clauses` | fix | answerSpec: normalisedText | `normalisedText` | Although the wind was strong, the boat reached the shore. | grammar target changed | medium | YES |
...
| `qg_p18_p15_formality_formal_rewrite` | `formality` | rewrite | answerSpec: normalisedText | `normalisedText` | Please discover whether the hall is open. | grammar target changed | high | YES |
...
| `qg_p18_p15_hyphen_ambiguity_hyphen_fix` | `hyphen_ambiguity` | fix | answerSpec: normalisedText | `normalisedText` | man-eating shark | grammar target changed | high | YES |
...
| `qg_p18_p15_noun_phrases_build_np_context` | `noun_phrases` | build | answerSpec: normalisedText | `normalisedText` | the nervous goalkeeper with muddy gloves | grammar target changed | medium | YES |
...
| `qg_p18_p15_parenthesis_commas_parenthesis_fix` | `parenthesis_commas` | fix | answerSpec: normalisedText | `normalisedText` | Our class visited York, the oldest city on our route, first. | grammar target changed | medium | YES |
| `qg_p18_p15_parenthesis_commas_parenthesis_replace` | `parenthesis_commas` | rewrite | answerSpec: normalisedText | `normalisedText` | Our class visited York (the oldest city on our route) first. | grammar target changed | medium | YES |
...
| `qg_p18_p15_pronouns_cohesion_cohesion_rewrite` | `pronouns_cohesion` | rewrite | answerSpec: normalisedText | `normalisedText` | Amira picked up the map. She folded it carefully. | grammar target changed | high | YES |
...
| `qg_p18_p15_relative_clauses_punctuate_relative_clause` | `relative_clauses` | fix | answerSpec: normalisedText | `normalisedText` | The girl, who had lost her ticket, waited by the gate. | grammar target changed | medium | YES |
...
| `qg_p18_p15_sentence_functions_punctuate_by_function` | `sentence_functions` | fix | answerSpec: normalisedText | `normalisedText` | Close the library door quietly. | grammar target changed | medium | YES |
...
| `qg_p18_p15_speech_punctuation_speech_fix` | `speech_punctuation` | fix | answerSpec: normalisedText | `normalisedText` | "Where are you going?" asked Mum. | grammar target changed | medium | YES |
...
| `qg_p18_p15_standard_english_standard_transfer` | `standard_english` | rewrite | answerSpec: normalisedText | `normalisedText` | We were late for assembly. | grammar target changed | medium | YES |
...
| `qg_p18_p15_tense_aspect_tense_rewrite` | `tense_aspect` | rewrite | answerSpec: normalisedText | `normalisedText` | I have finished my homework. | grammar target changed | medium | YES |
...
| `qg_p18_p16_active_passive_agent_object_explain` | `active_passive` | explain | answerSpec: normalisedText | `normalisedText` | The doer is in the by-phrase and the affected thing is the subject of the passive sentence. | grammar target changed | high | YES |
| `qg_p18_p16_active_passive_rewrite_voice` | `active_passive` | rewrite | answerSpec: normalisedText | `normalisedText` | The bread was baked by the chef. | grammar target changed | high | YES |
...
| `qg_p18_p16_active_passive_tense_preserving_voice` | `active_passive` | rewrite | answerSpec: normalisedText | `normalisedText` | The bread was baked by the chef. | grammar target changed | high | YES |
...
| `qg_p18_p16_adverbials_explain_fronted_comma` | `adverbials` | explain | answerSpec: normalisedText | `normalisedText` | The comma separates the fronted adverbial "Before sunrise" from the main clause. | grammar target changed | medium | YES |
...
| `qg_p18_p16_adverbials_fronted_comma_fix` | `adverbials` | fix | answerSpec: normalisedText | `normalisedText` | Before sunrise, the campers packed their bags. | grammar target changed | medium | YES |
| `qg_p18_p16_adverbials_move_adverbial_to_front` | `adverbials` | rewrite | answerSpec: normalisedText | `normalisedText` | Before sunrise, the campers packed their bags. | grammar target changed | medium | YES |
...
| `qg_p18_p16_apostrophes_possession_explain_position` | `apostrophes_possession` | explain | answerSpec: normalisedText | `normalisedText` | The apostrophe position shows whether one owner or more than one owner possesses the noun. | grammar target changed | medium | YES |
...
| `qg_p18_p16_boundary_punctuation_explain_colon_semicolon_dash` | `boundary_punctuation` | explain | answerSpec: normalisedText | `normalisedText` | The semicolon helps show the relationship between the two parts of the sentence. | grammar target changed | medium | YES |
| `qg_p18_p16_boundary_punctuation_insert_boundary_mark` | `boundary_punctuation` | fix | answerSpec: normalisedText | `normalisedText` | The sky darkened; the gulls flew inland. | grammar target changed | medium | YES |
...
| `qg_p18_p16_clauses_explain_subordination` | `clauses` | explain | answerSpec: normalisedText | `normalisedText` | It begins with "Although" and depends on the main clause "the boat reached the shore" to complete the meaning. | grammar target changed | medium | YES |
| `qg_p18_p16_clauses_fragment_or_sentence` | `clauses` | choose | answerSpec: exact | `exact` | fragment | wrong visible option value | low | NO |
| `qg_p18_p16_clauses_join_with_given_conjunction` | `clauses` | rewrite | answerSpec: normalisedText | `normalisedText` | Although the wind was strong, the boat reached the shore. | grammar target changed | medium | YES |
...
| `qg_p18_p16_clauses_punctuate_subordinate_first` | `clauses` | fix | answerSpec: normalisedText | `normalisedText` | Although the wind was strong, the boat reached the shore. | grammar target changed | medium | YES |
...
| `qg_p18_p16_formality_explain_formality_effect` | `formality` | explain | answerSpec: normalisedText | `normalisedText` | "request" sounds more precise and less conversational than "ask for". | grammar target changed | high | YES |
| `qg_p18_p16_formality_formal_sentence_rewrite` | `formality` | rewrite | answerSpec: normalisedText | `normalisedText` | Please request whether the hall is open. | grammar target changed | high | YES |
...
| `qg_p18_p16_hyphen_ambiguity_explain_hyphen_meaning` | `hyphen_ambiguity` | explain | answerSpec: normalisedText | `normalisedText` | The hyphen links words so they work together to express "a shark that eats people". | grammar target changed | high | YES |
| `qg_p18_p16_hyphen_ambiguity_fix_ambiguous_phrase` | `hyphen_ambiguity` | fix | answerSpec: normalisedText | `normalisedText` | man-eating shark | grammar target changed | high | YES |
...
| `qg_p18_p16_modal_verbs_change_force_rewrite` | `modal_verbs` | rewrite | answerSpec: normalisedText | `normalisedText` | You should wear a helmet on this trail. | grammar target changed | high | YES |
...
| `qg_p18_p16_modal_verbs_modal_context_explain` | `modal_verbs` | explain | answerSpec: normalisedText | `normalisedText` | It fits because it shows strong advice. | grammar target changed | high | YES |
...
| `qg_p18_p16_noun_phrases_build_with_given_head` | `noun_phrases` | build | answerSpec: normalisedText | `normalisedText` | the bright explorer near the library | grammar target changed | medium | YES |
| `qg_p18_p16_noun_phrases_expand_plain_noun` | `noun_phrases` | rewrite | answerSpec: normalisedText | `normalisedText` | the bright gate beside the library | grammar target changed | medium | YES |
...
| `qg_p18_p16_noun_phrases_explain_expansion` | `noun_phrases` | explain | answerSpec: normalisedText | `normalisedText` | It is centred on a noun and has extra words that describe or specify that noun. | grammar target changed | medium | YES |
...
| `qg_p18_p16_parenthesis_commas_add_parenthesis_commas` | `parenthesis_commas` | fix | answerSpec: normalisedText | `normalisedText` | Luca, who was first in line, opened the door. | grammar target changed | medium | YES |
...
| `qg_p18_p16_parenthesis_commas_explain_parenthesis` | `parenthesis_commas` | explain | answerSpec: normalisedText | `normalisedText` | The commas mark extra information that could be lifted out without destroying the main sentence. | grammar target changed | medium | YES |
...
| `qg_p18_p16_parenthesis_commas_replace_brackets_with_commas` | `parenthesis_commas` | rewrite | answerSpec: normalisedText | `normalisedText` | Luca, who was first in line, opened the door. | grammar target changed | medium | YES |
...
| `qg_p18_p16_pronouns_cohesion_explain_cohesion` | `pronouns_cohesion` | explain | answerSpec: normalisedText | `normalisedText` | The pronouns avoid repetition while still making it clear who or what each pronoun refers to. | grammar target changed | high | YES |
| `qg_p18_p16_pronouns_cohesion_fix_pronoun_reference` | `pronouns_cohesion` | fix | answerSpec: normalisedText | `normalisedText` | Amira picked up the map. She folded it carefully. | grammar target changed | high | YES |
| `qg_p18_p16_pronouns_cohesion_reduce_repetition_rewrite` | `pronouns_cohesion` | rewrite | answerSpec: normalisedText | `normalisedText` | Amira picked up the map. She folded it carefully. | grammar target changed | high | YES |
...
| `qg_p18_p16_relative_clauses_add_commas_non_defining` | `relative_clauses` | fix | answerSpec: normalisedText | `normalisedText` | The teacher who had visited Egypt helped us. | grammar target changed | medium | YES |
...
| `qg_p18_p16_relative_clauses_explain_relative_clause` | `relative_clauses` | explain | answerSpec: normalisedText | `normalisedText` | It adds information about a noun and begins with a relative word such as who, which, that, where or whose. | grammar target changed | medium | YES |
...
| `qg_p18_p16_sentence_functions_explain_function_reasoning` | `sentence_functions` | explain | answerSpec: normalisedText | `normalisedText` | It begins with What and follows the exclamation structure. | grammar target changed | medium | YES |
...
| `qg_p18_p16_sentence_functions_repair_wrong_function_punctuation` | `sentence_functions` | fix | answerSpec: normalisedText | `normalisedText` | Turn off the tap. | grammar target changed | medium | YES |
| `qg_p18_p16_speech_punctuation_explain_speech_rule` | `speech_punctuation` | explain | answerSpec: normalisedText | `normalisedText` | The spoken words go inside speech marks, and the sentence punctuation belongs inside the closing speech mark when it is part of the speech. | grammar target changed | medium | YES |
| `qg_p18_p16_speech_punctuation_fix_punctuation_outside_marks` | `speech_punctuation` | fix | answerSpec: normalisedText | `normalisedText` | "Where are you going?" asked Mum. | grammar target changed | medium | YES |
...
| `qg_p18_p16_speech_punctuation_punctuate_direct_speech` | `speech_punctuation` | fix | answerSpec: normalisedText | `normalisedText` | "Where are you going?" asked Mum. | grammar target changed | medium | YES |
...
| `qg_p18_p16_standard_english_explain_standard_choice` | `standard_english` | explain | answerSpec: normalisedText | `normalisedText` | It uses the accepted written form rather than the non-standard spoken form "We was late.". | grammar target changed | medium | YES |
| `qg_p18_p16_standard_english_fix_nonstandard` | `standard_english` | fix | answerSpec: normalisedText | `normalisedText` | We were late. | grammar target changed | medium | YES |
| `qg_p18_p16_standard_english_rewrite_standard_english` | `standard_english` | rewrite | answerSpec: normalisedText | `normalisedText` | We were late. | grammar target changed | medium | YES |
...
| `qg_p18_p16_subject_object_explain_roles` | `subject_object` | explain | answerSpec: normalisedText | `normalisedText` | The subject is The noisy gull; the object is the sandwich. | grammar target changed | high | YES |
...
| `qg_p18_p16_subject_object_rewrite_preserve_roles` | `subject_object` | rewrite | answerSpec: normalisedText | `normalisedText` | The noisy gull stole the sandwich from Max. | grammar target changed | high | YES |
...
| `qg_p18_p16_tense_aspect_fix_wrong_form` | `tense_aspect` | fix | answerSpec: normalisedText | `normalisedText` | I have finished my homework. | grammar target changed | medium | YES |
| `qg_p18_p16_tense_aspect_form_explanation` | `tense_aspect` | explain | answerSpec: normalisedText | `normalisedText` | It uses the helping verb pattern needed for the present perfect and changes the main verb correctly. | grammar target changed | medium | YES |
| `qg_p18_p16_tense_aspect_rewrite_to_named_form` | `tense_aspect` | rewrite | answerSpec: normalisedText | `normalisedText` | I have finished my homework. | grammar target changed | medium | YES |
...
| `qg_p18_p16_word_classes_build_word_class_sentence` | `word_classes` | build | answerSpec: normalisedText | `normalisedText` | Ben often cycles to school. | grammar target changed | medium | YES |
...
| `qg_p18_p16_word_classes_same_word_different_job` | `word_classes` | explain | answerSpec: normalisedText | `normalisedText` | In the first sentence it is a noun; in the second it is a verb. | grammar target changed | medium | YES |
...
| `qg_p18_p17_active_passive_misconception_repair` | `active_passive` | fix | answerSpec: normalisedText | `normalisedText` | The bread was baked by the chef. | grammar target changed | high | YES |
...
| `qg_p18_p17_active_passive_transfer_apply` | `active_passive` | build | answerSpec: normalisedText | `normalisedText` | Answer: The bread was baked by the chef.. New example should show the same rule. | grammar target changed | high | YES |
| `qg_p18_p17_active_passive_written_reason` | `active_passive` | explain | answerSpec: normalisedText | `normalisedText` | The bread was baked by the chef. is best because the object becomes the subject in the passive. | grammar target changed | high | YES |
| `qg_p18_p17_adverbials_misconception_repair` | `adverbials` | fix | answerSpec: normalisedText | `normalisedText` | Before the match | grammar target changed | medium | YES |
...
| `qg_p18_p17_adverbials_transfer_apply` | `adverbials` | build | answerSpec: normalisedText | `normalisedText` | Answer: Before the match. New example should show the same rule. | grammar target changed | medium | YES |
| `qg_p18_p17_adverbials_written_reason` | `adverbials` | explain | answerSpec: normalisedText | `normalisedText` | Before the match is best because the opening phrase tells when. | grammar target changed | medium | YES |
...
| `qg_p18_p17_apostrophes_possession_misconception_repair` | `apostrophes_possession` | fix | answerSpec: normalisedText | `normalisedText` | the dog's bowl | grammar target changed | medium | YES |
...
| `qg_p18_p17_apostrophes_possession_transfer_apply` | `apostrophes_possession` | build | answerSpec: normalisedText | `normalisedText` | Answer: the dog's bowl. New example should show the same rule. | grammar target changed | medium | YES |
| `qg_p18_p17_apostrophes_possession_written_reason` | `apostrophes_possession` | explain | answerSpec: normalisedText | `normalisedText` | the dog's bowl is best because one dog owns the bowl, so apostrophe before s. | grammar target changed | medium | YES |
...
| `qg_p18_p17_boundary_punctuation_misconception_repair` | `boundary_punctuation` | fix | answerSpec: normalisedText | `normalisedText` | ; | grammar target changed | medium | YES |
...
| `qg_p18_p17_boundary_punctuation_transfer_apply` | `boundary_punctuation` | build | answerSpec: normalisedText | `normalisedText` | Answer:;. New example should show the same rule. | grammar target changed | medium | YES |
| `qg_p18_p17_boundary_punctuation_written_reason` | `boundary_punctuation` | explain | answerSpec: normalisedText | `normalisedText` | ; is best because a semi-colon can join two closely related main clauses. | grammar target changed | medium | YES |
...
| `qg_p18_p17_clauses_misconception_repair` | `clauses` | fix | answerSpec: normalisedText | `normalisedText` | Although the path was muddy | grammar target changed | medium | YES |
...
| `qg_p18_p17_clauses_transfer_apply` | `clauses` | build | answerSpec: normalisedText | `normalisedText` | Answer: Although the path was muddy. New example should show the same rule. | grammar target changed | medium | YES |
| `qg_p18_p17_clauses_written_reason` | `clauses` | explain | answerSpec: normalisedText | `normalisedText` | Although the path was muddy is best because it cannot stand alone as a full sentence in this context. | grammar target changed | medium | YES |
| `qg_p18_p17_formality_misconception_repair` | `formality` | fix | answerSpec: normalisedText | `normalisedText` | request | grammar target changed | high | YES |
...
| `qg_p18_p17_formality_transfer_apply` | `formality` | build | answerSpec: normalisedText | `normalisedText` | Answer: request. New example should show the same rule. | grammar target changed | high | YES |
| `qg_p18_p17_formality_written_reason` | `formality` | explain | answerSpec: normalisedText | `normalisedText` | request is best because request is more formal. | grammar target changed | high | YES |
...
| `qg_p18_p17_hyphen_ambiguity_misconception_repair` | `hyphen_ambiguity` | fix | answerSpec: normalisedText | `normalisedText` | man-eating shark | grammar target changed | high | YES |
...
| `qg_p18_p17_hyphen_ambiguity_transfer_apply` | `hyphen_ambiguity` | build | answerSpec: normalisedText | `normalisedText` | Answer: man-eating shark. New example should show the same rule. | grammar target changed | high | YES |
| `qg_p18_p17_hyphen_ambiguity_written_reason` | `hyphen_ambiguity` | explain | answerSpec: normalisedText | `normalisedText` | man-eating shark is best because the hyphen links man and eating as a compound adjective. | grammar target changed | high | YES |
| `qg_p18_p17_modal_verbs_misconception_repair` | `modal_verbs` | fix | answerSpec: normalisedText | `normalisedText` | should | grammar target changed | high | YES |
...
| `qg_p18_p17_modal_verbs_transfer_apply` | `modal_verbs` | build | answerSpec: normalisedText | `normalisedText` | Answer: should. New example should show the same rule. | grammar target changed | high | YES |
| `qg_p18_p17_modal_verbs_written_reason` | `modal_verbs` | explain | answerSpec: normalisedText | `normalisedText` | should is best because should gives strong advice. | grammar target changed | high | YES |
...
| `qg_p18_p17_noun_phrases_misconception_repair` | `noun_phrases` | fix | answerSpec: normalisedText | `normalisedText` | expanded noun phrase | grammar target changed | medium | YES |
...
| `qg_p18_p17_noun_phrases_transfer_apply` | `noun_phrases` | build | answerSpec: normalisedText | `normalisedText` | Answer: expanded noun phrase. New example should show the same rule. | grammar target changed | medium | YES |
| `qg_p18_p17_noun_phrases_written_reason` | `noun_phrases` | explain | answerSpec: normalisedText | `normalisedText` | expanded noun phrase is best because it centres on bowl and adds detail. | grammar target changed | medium | YES |
| `qg_p18_p17_parenthesis_commas_misconception_repair` | `parenthesis_commas` | fix | answerSpec: normalisedText | `normalisedText` | Our guide, who had visited before, led us inside. | grammar target changed | medium | YES |
...
| `qg_p18_p17_parenthesis_commas_transfer_apply` | `parenthesis_commas` | build | answerSpec: normalisedText | `normalisedText` | Answer: Our guide, who had visited before, led us inside.. New example should show the same rule. | grammar target changed | medium | YES |
| `qg_p18_p17_parenthesis_commas_written_reason` | `parenthesis_commas` | explain | answerSpec: normalisedText | `normalisedText` | Our guide, who had visited before, led us inside. is best because commas mark the extra relative information. | grammar target changed | medium | YES |
| `qg_p18_p17_pronouns_cohesion_misconception_repair` | `pronouns_cohesion` | fix | answerSpec: normalisedText | `normalisedText` | clear | grammar target changed | high | YES |
...
| `qg_p18_p17_pronouns_cohesion_transfer_apply` | `pronouns_cohesion` | build | answerSpec: normalisedText | `normalisedText` | Answer: clear. New example should show the same rule. | grammar target changed | high | YES |
| `qg_p18_p17_pronouns_cohesion_written_reason` | `pronouns_cohesion` | explain | answerSpec: normalisedText | `normalisedText` | clear is best because she refers to Amira and it refers to the map. | grammar target changed | high | YES |
| `qg_p18_p17_relative_clauses_misconception_repair` | `relative_clauses` | fix | answerSpec: normalisedText | `normalisedText` | who won the race | grammar target changed | medium | YES |
...
| `qg_p18_p17_relative_clauses_transfer_apply` | `relative_clauses` | build | answerSpec: normalisedText | `normalisedText` | Answer: who won the race. New example should show the same rule. | grammar target changed | medium | YES |
| `qg_p18_p17_relative_clauses_written_reason` | `relative_clauses` | explain | answerSpec: normalisedText | `normalisedText` | who won the race is best because it adds information about the girl. | grammar target changed | medium | YES |
| `qg_p18_p17_sentence_functions_misconception_repair` | `sentence_functions` | fix | answerSpec: normalisedText | `normalisedText` | command | grammar target changed | medium | YES |
...
| `qg_p18_p17_sentence_functions_transfer_apply` | `sentence_functions` | build | answerSpec: normalisedText | `normalisedText` | Answer: command. New example should show the same rule. | grammar target changed | medium | YES |
| `qg_p18_p17_sentence_functions_written_reason` | `sentence_functions` | explain | answerSpec: normalisedText | `normalisedText` | command is best because it tells someone to do something. | grammar target changed | medium | YES |
...
| `qg_p18_p17_speech_punctuation_misconception_repair` | `speech_punctuation` | fix | answerSpec: normalisedText | `normalisedText` | "Where are you going?" asked Mum. | grammar target changed | medium | YES |
...
| `qg_p18_p17_speech_punctuation_transfer_apply` | `speech_punctuation` | build | answerSpec: normalisedText | `normalisedText` | Answer: "Where are you going?" asked Mum.. New example should show the same rule. | grammar target changed | medium | YES |
| `qg_p18_p17_speech_punctuation_written_reason` | `speech_punctuation` | explain | answerSpec: normalisedText | `normalisedText` | "Where are you going?" asked Mum. is best because the question mark belongs inside the speech marks. | grammar target changed | medium | YES |
| `qg_p18_p17_standard_english_misconception_repair` | `standard_english` | fix | answerSpec: normalisedText | `normalisedText` | were | grammar target changed | medium | YES |
...
| `qg_p18_p17_standard_english_transfer_apply` | `standard_english` | build | answerSpec: normalisedText | `normalisedText` | Answer: were. New example should show the same rule. | grammar target changed | medium | YES |
| `qg_p18_p17_standard_english_written_reason` | `standard_english` | explain | answerSpec: normalisedText | `normalisedText` | were is best because standard English uses were with we. | grammar target changed | medium | YES |
...
| `qg_p18_p17_subject_object_misconception_repair` | `subject_object` | fix | answerSpec: normalisedText | `normalisedText` | the sandwich | grammar target changed | high | YES |
...
| `qg_p18_p17_subject_object_transfer_apply` | `subject_object` | build | answerSpec: normalisedText | `normalisedText` | Answer: the sandwich. New example should show the same rule. | grammar target changed | high | YES |
| `qg_p18_p17_subject_object_written_reason` | `subject_object` | explain | answerSpec: normalisedText | `normalisedText` | the sandwich is best because the sandwich receives the action. | grammar target changed | high | YES |
...
| `qg_p18_p17_tense_aspect_misconception_repair` | `tense_aspect` | fix | answerSpec: normalisedText | `normalisedText` | has finished | grammar target changed | medium | YES |
...
| `qg_p18_p17_tense_aspect_transfer_apply` | `tense_aspect` | build | answerSpec: normalisedText | `normalisedText` | Answer: has finished. New example should show the same rule. | grammar target changed | medium | YES |
| `qg_p18_p17_tense_aspect_written_reason` | `tense_aspect` | explain | answerSpec: normalisedText | `normalisedText` | has finished is best because present perfect links the past action to now. | grammar target changed | medium | YES |
...
| `qg_p18_p17_word_classes_misconception_repair` | `word_classes` | fix | answerSpec: normalisedText | `normalisedText` | adverb | grammar target changed | medium | YES |
...
| `qg_p18_p17_word_classes_transfer_apply` | `word_classes` | build | answerSpec: normalisedText | `normalisedText` | Answer: adverb. New example should show the same rule. | grammar target changed | medium | YES |
| `qg_p18_p17_word_classes_written_reason` | `word_classes` | explain | answerSpec: normalisedText | `normalisedText` | adverb is best because it tells how Maya folded. | grammar target changed | medium | YES |
| `qg_p18_p18_active_passive_application_transfer` | `active_passive` | explain | answerSpec: normalisedText | `normalisedText` | The object becomes the subject in the passive. | grammar target changed | high | YES |
...
| `qg_p18_p18_active_passive_precision_repair_or_rewrite` | `active_passive` | rewrite | answerSpec: normalisedText | `normalisedText` | The bread was baked by the chef. | grammar target changed | high | YES |
...
| `qg_p18_p18_active_passive_subject_object_voice_subject_object_roles` | `active_passive`, `subject_object` | explain | answerSpec: normalisedText | `normalisedText` | The bread was baked by the chef.; object: the sandwich | grammar target changed | high | YES |
| `qg_p18_p18_adverbials_application_transfer` | `adverbials` | explain | answerSpec: normalisedText | `normalisedText` | Before the bell, the children lined up quietly. | grammar target changed | medium | YES |
| `qg_p18_p18_adverbials_clauses_adverbial_clause_join` | `adverbials`, `clauses` | explain | answerSpec: normalisedText | `normalisedText` | Before the bell, the children lined up quietly.; Although the path was muddy | grammar target changed | medium | YES |
...
| `qg_p18_p18_adverbials_precision_repair_or_rewrite` | `adverbials` | fix | answerSpec: normalisedText | `normalisedText` | Before the bell, the children lined up quietly. | grammar target changed | medium | YES |
...
| `qg_p18_p18_apostrophes_possession_application_transfer` | `apostrophes_possession` | explain | answerSpec: normalisedText | `normalisedText` | One dog owns the bowl, so apostrophe before s. | grammar target changed | medium | YES |
...
| `qg_p18_p18_apostrophes_possession_hyphen_ambiguity_possession_hyphen_precision` | `apostrophes_possession`, `hyphen_ambiguity` | explain | answerSpec: normalisedText | `normalisedText` | the dog's bowl; man-eating shark | grammar target changed | high | YES |
...
| `qg_p18_p18_boundary_punctuation_application_transfer` | `boundary_punctuation` | explain | answerSpec: normalisedText | `normalisedText` | A semi-colon links two related main clauses. | grammar target changed | medium | YES |
...
| `qg_p18_p18_boundary_punctuation_speech_punctuation_boundary_speech_punctuation` | `boundary_punctuation`, `speech_punctuation` | explain | answerSpec: normalisedText | `normalisedText` | semicolon; "Where are you going?" asked Mum. | grammar target changed | medium | YES |
| `qg_p18_p18_clauses_application_transfer` | `clauses` | explain | answerSpec: normalisedText | `normalisedText` | Although the path was muddy, the hikers kept walking. | grammar target changed | medium | YES |
...
| `qg_p18_p18_formality_application_transfer` | `formality` | explain | answerSpec: normalisedText | `normalisedText` | Established is more formal than got set up. | grammar target changed | high | YES |
...
| `qg_p18_p18_formality_precision_repair_or_rewrite` | `formality` | rewrite | answerSpec: normalisedText | `normalisedText` | The club was established last year. | grammar target changed | high | YES |
...
| `qg_p18_p18_hyphen_ambiguity_application_transfer` | `hyphen_ambiguity` | explain | answerSpec: normalisedText | `normalisedText` | The hyphen shows man-eating describes the shark. | grammar target changed | high | YES |
...
| `qg_p18_p18_hyphen_ambiguity_precision_repair_or_rewrite` | `hyphen_ambiguity` | fix | answerSpec: normalisedText | `normalisedText` | man-eating shark | grammar target changed | high | YES |
...
| `qg_p18_p18_modal_verbs_application_transfer` | `modal_verbs` | explain | answerSpec: normalisedText | `normalisedText` | Should gives strong advice. | grammar target changed | high | YES |
...
| `qg_p18_p18_modal_verbs_formality_modal_formality_strength` | `formality`, `modal_verbs` | explain | answerSpec: normalisedText | `normalisedText` | should; The club was established last year. | grammar target changed | high | YES |
...
| `qg_p18_p18_noun_phrases_application_transfer` | `noun_phrases` | explain | answerSpec: normalisedText | `normalisedText` | rolled beneath is not centred on a noun; the small blue marble is a noun phrase. | grammar target changed | medium | YES |
...
| `qg_p18_p18_noun_phrases_precision_repair_or_rewrite` | `noun_phrases` | fix | answerSpec: normalisedText | `normalisedText` | the small blue marble rolled beneath the sofa. | grammar target changed | medium | YES |
...
| `qg_p18_p18_parenthesis_commas_application_transfer` | `parenthesis_commas` | explain | answerSpec: normalisedText | `normalisedText` | Commas mark the parenthesis. | grammar target changed | medium | YES |
...
| `qg_p18_p18_parenthesis_commas_precision_repair_or_rewrite` | `parenthesis_commas` | fix | answerSpec: normalisedText | `normalisedText` | Luca, who was first in line, opened the door. | grammar target changed | medium | YES |
...
| `qg_p18_p18_pronouns_cohesion_application_transfer` | `pronouns_cohesion` | explain | answerSpec: normalisedText | `normalisedText` | The pronouns clearly refer back to Amira and the map. | grammar target changed | high | YES |
...
| `qg_p18_p18_pronouns_cohesion_formality_cohesion_formality_choice` | `formality`, `pronouns_cohesion` | explain | answerSpec: normalisedText | `normalisedText` | Amira picked up the map. She folded it carefully.; The club was established last year. | grammar target changed | high | YES |
| `qg_p18_p18_pronouns_cohesion_precision_repair_or_rewrite` | `pronouns_cohesion` | rewrite | answerSpec: normalisedText | `normalisedText` | Amira picked up the map. She folded it carefully. | grammar target changed | high | YES |
...
| `qg_p18_p18_relative_clauses_application_transfer` | `relative_clauses` | explain | answerSpec: normalisedText | `normalisedText` | The artist who painted the mural visited our class. | grammar target changed | medium | YES |
...
| `qg_p18_p18_relative_clauses_parenthesis_commas_relative_parenthesis_punctuation` | `parenthesis_commas`, `relative_clauses` | explain | answerSpec: normalisedText | `normalisedText` | who painted the mural; Commas mark the parenthesis. | grammar target changed | medium | YES |
...
| `qg_p18_p18_sentence_functions_application_transfer` | `sentence_functions` | explain | answerSpec: normalisedText | `normalisedText` | It is a command because it tells someone what to do. | grammar target changed | medium | YES |
...
| `qg_p18_p18_sentence_functions_precision_repair_or_rewrite` | `sentence_functions` | fix | answerSpec: normalisedText | `normalisedText` | Please return the atlas to the shelf. | grammar target changed | medium | YES |
...
| `qg_p18_p18_sentence_functions_speech_punctuation_function_speech_boundary` | `sentence_functions`, `speech_punctuation` | explain | answerSpec: normalisedText | `normalisedText` | command; "Where are you going?" asked Mum. | grammar target changed | medium | YES |
| `qg_p18_p18_speech_punctuation_application_transfer` | `speech_punctuation` | explain | answerSpec: normalisedText | `normalisedText` | The question mark belongs inside the speech marks. | grammar target changed | medium | YES |
...
| `qg_p18_p18_speech_punctuation_precision_repair_or_rewrite` | `speech_punctuation` | fix | answerSpec: normalisedText | `normalisedText` | "Where are you going?" asked Mum. | grammar target changed | medium | YES |
...
| `qg_p18_p18_standard_english_application_transfer` | `standard_english` | explain | answerSpec: normalisedText | `normalisedText` | Were is the Standard English form with we. | grammar target changed | medium | YES |
...
| `qg_p18_p18_subject_object_application_transfer` | `subject_object` | explain | answerSpec: normalisedText | `normalisedText` | The noisy gull is the subject; the sandwich is the object. The gull does the stealing; the sandwich receives the action. | grammar target changed | high | YES |
...
| `qg_p18_p18_tense_aspect_application_transfer` | `tense_aspect` | explain | answerSpec: normalisedText | `normalisedText` | Past perfect uses had plus past participle for an earlier past action. | grammar target changed | medium | YES |
...
| `qg_p18_p18_tense_aspect_precision_repair_or_rewrite` | `tense_aspect` | rewrite | answerSpec: normalisedText | `normalisedText` | She had packed her bag before the trip. | grammar target changed | medium | YES |
...
| `qg_p18_p18_tense_aspect_standard_english_tense_standard_register` | `standard_english`, `tense_aspect` | explain | answerSpec: normalisedText | `normalisedText` | She had packed her bag before the trip.; We were late for practice. | grammar target changed | medium | YES |
| `qg_p18_p18_word_classes_application_transfer` | `word_classes` | explain | answerSpec: normalisedText | `normalisedText` | It is a adverb because it describes how maya folded the map. | grammar target changed | medium | YES |
...
| `qg_p18_p18_word_classes_noun_phrases_word_class_np_roles` | `noun_phrases`, `word_classes` | explain | answerSpec: normalisedText | `normalisedText` | adverb; head noun marble | grammar target changed | medium | YES |
