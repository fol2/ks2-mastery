...
| `qg_p14_fronted_adverbials_constructed_rewrite` | `adverbials` | rewrite | answerSpec: manualReviewOnly | `manualReviewOnly` | Before the final bell, Eli carried the history poster carefully. | grammar target changed | medium | YES |
...
| `qg_p14_speech_punctuation_constructed_rewrite` | `speech_punctuation` | rewrite | answerSpec: manualReviewOnly | `manualReviewOnly` | "Our team won the relay," Cara said. | grammar target changed | medium | YES |
...
| `qg_p14_parenthesis_commas_constructed_rewrite` | `parenthesis_commas` | rewrite | answerSpec: manualReviewOnly | `manualReviewOnly` | Imani found the science folder, which everyone recognised at once, near the office. | grammar target changed | medium | YES |
