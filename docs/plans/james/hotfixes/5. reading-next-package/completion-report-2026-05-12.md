...
The application code deployed from commit `24757e1eee48b9d0b3134674d5909cb4fa6e32ff` (`Defer Punctuation runtime bank startup`). The Reading stretch implementation landed in the earlier commit `53d4f880d379350b79713aaa98506865f105a2ea` (`Complete Reading stretch challenge hotfix`).
...
- `validation/final-npm-test.log`: `npm test`, 111478 tests, 111466 passed, 0 failed, 12 skipped.
...
- `validation/final-production-deploy.status.json`: deployed Worker version `89927860-7a47-461a-a3f5-14fe4ed38e04`, startup time 300 ms, Workers URL `https://ks2-mastery.fol2hk.workers.dev`, production URL `https://ks2.eugnel.uk/`.
...
- `validation/final-production-reading-smoke.json`: live Reading API smoke passed against Reading content version 5 and commit `24757e1eee48b9d0b3134674d5909cb4fa6e32ff`.
...
The final production app code is the deployed commit `24757e1eee48b9d0b3134674d5909cb4fa6e32ff`. Subsequent evidence and report commits are documentation and verification artefacts only.
