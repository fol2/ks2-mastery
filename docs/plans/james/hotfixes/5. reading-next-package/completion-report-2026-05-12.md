...
The application code deployed from commit `9681d2cbf6d814f939fba43e580e12305ee145f5` (`Refresh Reading production closure evidence`). The Reading stretch implementation landed in the earlier commit `53d4f880d379350b79713aaa98506865f105a2ea` (`Complete Reading stretch challenge hotfix`), and the required Worker startup fixes are included through the rebased mainline.
...
- `validation/final-production-deploy.status.json`: deployed Worker version `a6051648-2084-48ad-8e0c-a3c06b7c3689`, startup time 218 ms, Workers URL `https://ks2-mastery.fol2hk.workers.dev`, production URL `https://ks2.eugnel.uk/`.
...
The final production app code is the deployed commit `9681d2cbf6d814f939fba43e580e12305ee145f5`. Subsequent evidence refresh commits are documentation and verification artefacts only.
