...
The application code deployed from commit `eb48166622876499a01f00969c946eaa2b78ac1f` (`Refresh Reading evidence after latest main rebase`). The Reading stretch implementation landed in the earlier commit `53d4f880d379350b79713aaa98506865f105a2ea` (`Complete Reading stretch challenge hotfix`), and the required Worker startup fixes are included through the rebased mainline.
...
- `validation/final-npm-test.log`: `npm test`, 111490 tests, 111478 passed, 0 failed, 12 skipped.
...
- `validation/final-production-deploy.status.json`: deployed Worker version `f761e084-dad9-4037-a476-6e148551cfa2`, startup time 179 ms, Workers URL `https://ks2-mastery.fol2hk.workers.dev`, production URL `https://ks2.eugnel.uk/`.
...
- `validation/final-production-reading-smoke.json`: live Reading API smoke passed against Reading content version 5 and commit `eb48166622876499a01f00969c946eaa2b78ac1f`.
...
The final production app code is the deployed commit `eb48166622876499a01f00969c946eaa2b78ac1f`. Subsequent evidence refresh commits are documentation and verification artefacts only.
