...
- `evidence/secure-extension-import-approval-record-2026-05-17.md` / `.json` - James's post-review owner approval for secure-extension import of all 1217 pinned candidate rows; this closes the adult approval evidence gap but does not fill row-specific release-quality field values.
