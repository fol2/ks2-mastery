...
| Approved-source targeted tests | `validation/secure-vocabulary-approved-source/targeted-tests.log` | passed | `node --test tests/spelling-secure-vocabulary-source.test.js tests/secure-vocabulary-release-gates.test.js`: 5 tests passed. |
