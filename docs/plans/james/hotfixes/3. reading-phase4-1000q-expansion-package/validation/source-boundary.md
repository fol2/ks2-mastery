...
Production authority: claimed after the repository integration landed on GitHub `main` at `a81c8692c72dc0ed975eca7b3a626aa1157a6acc` and the deployed `https://ks2.eugnel.uk` Reading smoke recorded content version 4, 108 passages, 1052 questions, 41 papers, immediate-round success, delayed-paper success, and stale-write guard success. Evidence: `validation/production/reading-phase4-production-smoke-2026-05-11.json`.
