...
- [ ] Track remaining legacy functionality completeness in `docs/plans/2026-04-25-001-feat-grammar-functionality-completeness-plan.md`: strict mini-test and session goals/settings are complete; in-session repair, visible AI triggers, read aloud, adult/data replacement parity, and release gates remain.
