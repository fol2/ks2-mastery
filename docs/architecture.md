...
Inklet and Glimmerbug are caught into Stage 0 at 1 secure word, then evolve at 10, 30, 60 and 100 secure words in their own spelling pools. Vellhorn follows the same direct-monster thresholds for the Extra pool. Phaeton is caught into Stage 0 at 3 combined secure words, then evolves from the combined secure-word total at 25, 95, 145 and 213.
