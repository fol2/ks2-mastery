...
export const CACHE_SPLIT_RULES = Object.freeze([
  ...
  { path: '/ks2-apostrophes-practice/', cacheControl: 'no-store' },
  { path: '/year-5-spelling-practice/', cacheControl: 'no-store' },
  { path: '/help-child-ks2-grammar-at-home/', cacheControl: 'no-store' },
