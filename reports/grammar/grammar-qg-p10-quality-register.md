...
**Generated:** 2026-04-30T01:49:50.943Z
**Templates:** 78
...
| 2 | `question_mark_select` | approved | - | 1..10 | ship-with-monitoring |
| 3 | `word_class_underlined_choice` | approved | - | 1..15 | ship |
| 4 | `identify_words_in_sentence` | approved | - | 1..15 | ship-with-monitoring |
| 5 | `expanded_noun_phrase_choice` | approved | - | 1..10 | ship |
| 6 | `build_noun_phrase` | approved | - | 1..15 | ship-with-monitoring |
...
| 15 | `standard_english_pairs` | approved | - | 1..10 | ship-with-monitoring |
| 16 | `pronoun_cohesion_choice` | approved | - | 1..10 | ship |
| 17 | `formality_pairs` | approved | - | 1..10 | ship-with-monitoring |
...
| 26 | `standard_fix_sentence` | approved | - | 1..15 | ship-with-monitoring |
...
| 43 | `proc2_fronted_adverbial_build` | approved | - | 1..15 | ship-with-monitoring |
...
| 47 | `proc3_noun_phrase_build` | approved | - | 1..15 | ship-with-monitoring |
...
- **Feedback:** Table-choice template — feedback delivered via row-level correctness indicators, not a text feedback field. Verified: incorrect selections produce red/correct produce green in the UI contract.
